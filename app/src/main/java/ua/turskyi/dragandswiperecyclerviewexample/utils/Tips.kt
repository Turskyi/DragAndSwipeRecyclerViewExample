package ua.turskyi.dragandswiperecyclerviewexample.utils
...
object Tips {
    ...
    private fun createTextToastView(message: String): FrameLayout? {
        ...
        val layout = Utils.getContext()?.let { FrameLayout(it) }
    ...
    private fun dp2px(dpValue: Float): Int {
        val scale: Float? = Utils.getContext()?.resources?.displayMetrics?.density
